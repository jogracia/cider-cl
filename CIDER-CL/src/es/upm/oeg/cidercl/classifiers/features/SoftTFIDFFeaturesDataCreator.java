 ...
 *
 */
public class SoftTFIDFFeaturesDataCreator extends SoftTFIDFBetweenOntologyEntities{

	private static Logger log = Logger.getLogger(SoftTFIDFFeaturesDataCreator.class);
	Instances class_features, property_features;
	HashSet<String> alignedURIs;
	
	public SoftTFIDFFeaturesDataCreator(Instances classFeaturesDataset, Instances propFeaturesDataset, HashSet<String> alignedURIsSet){
